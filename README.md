...
The schema follows the data model described above.
...
- One tenant
- Two users linked to the same tenant:
  - **TREASURER** (write access)
  - **VIEWER** (read-only access)

This setup allows testing RBAC and tenant isolation.
